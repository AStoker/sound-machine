...
static const char *const TAG = "tpa2016";
...
bool TPA2016::write_register_(uint8_t reg, uint8_t value, uint8_t verify_mask) {
...
bool TPA2016::read_faults(bool &fault_left, bool &fault_right, bool &thermal) {
  uint8_t value = 0;
...
void TPA2016::dump_config() {
  ESP_LOGCONFIG(TAG, "TPA2016 Amplifier:");
  LOG_I2C_DEVICE(this);
  if (this->is_failed()) {
