...
from esphome.components import background_sound, speaker
...
# ambience_player; see components/background_sound/background_sound.h.
...
noise_generator_ns = cg.esphome_ns.namespace("noise_generator")
NoiseGenerator = noise_generator_ns.class_("NoiseGenerator", background_sound.BackgroundSound)

NoiseColor = noise_generator_ns.enum("NoiseColor")
NOISE_COLORS = {
...
CONFIG_SCHEMA = cv.Schema(
    {
        cv.GenerateID(): cv.declare_id(NoiseGenerator),
