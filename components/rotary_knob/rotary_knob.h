...
class KnobHub : public i2c::I2CDevice, public Component {
 public:
  void setup() override;
 ...
 protected:
  i2c::ErrorCode write8(ChipModule mod, uint8_t reg, uint8_t value);
  i2c::ErrorCode write16(ChipModule mod, uint8_t reg, uint16_t value);
  i2c::ErrorCode write32(ChipModule mod, uint8_t reg, uint32_t value);
  i2c::ErrorCode readbuf(ChipModule mod, uint8_t reg, uint8_t *buf, uint8_t len);
...
class KnobGPIOPin : public GPIOPin {
 public:
  void setup() override;
