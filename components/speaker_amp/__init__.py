...
speaker_amp_ns = cg.esphome_ns.namespace("speaker_amp")
SpeakerAmp = speaker_amp_ns.class_("SpeakerAmp", cg.Component, i2c.I2CDevice)

Compression = speaker_amp_ns.enum("Compression")
COMPRESSION_RATIOS = {
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(SpeakerAmp),
